...
#
get_filename_component(filename "/workspace/build/_deps/bitset-subbuild/bitset-populate-prefix/src/v0.2.2.tar.gz" ABSOLUTE)
get_filename_component(directory "/workspace/build/_deps/bitset-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-bitset-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-bitset-populate${i}")
